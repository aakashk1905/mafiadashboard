        ...
        <div className="mc-task-cont">
          <div className="mc-tc-top">
            ...
            <div className="mc-tc-cont">
              ...
              <span>
                Tasks Completed: 0/0 (
                <b style={{ color: "#51B846" }}>New Tasks Coming soon!!</b>)
                {/* Tasks Completed: <b style={{ color: "#51B846" }}>4</b>{" "}
                <b style={{ color: "#fff" }}>/ 12</b> */}
              </span>
              <div className="prog-bar">
                <div className="prog-bar-active" style={{ width: "2%" }}></div>
              </div>
            </div>
          </div>
            ...
            <div className="mc-ls-cont">
              ...
              <div className="mc-ls">
                {/* <div className="mc-ls-sub">
                  <div className="mc-ls-head">Sketching</div>
                  <div className="mc-ls-text">
                    Salmaan, Aakash, Jatin, Shivam
                  </div>
                  <div className="mc-ls-text">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
